    ...
    t = jQuery, a = {
        ...
        getProducts: function () {
            ...
            for (let n in s) {
                ...
                f.click(function (a) {
                    a.preventDefault();
                    let r = t(this).data("sbId").toString(), n = +v.val(), i = +h.val(), o = i * n;
            ...
            a.smartBasketMinText && i.prepend(`<span class="shoping-cart">${a.smartBasketMinText}</span> `);
            ...
            if (c.append(p), a.agreement.isRequired) {
                ...
                r = a.agreement.isLink ? t("<a>").attr({
                    ...
                    target: "_blank",
                    rel: "nofollow"
                }) : t("<span>").attr({class: "smart-basket__link-agreement"}), s.is(":checked") ? r.text("Оплатить") : r.text("Оплатить"), e.click(function () {
                    s.is(":checked") ? (r.text("Оплатить"), s.val("Оплатить"), m.attr({disabled: "disabled"}), d.addClass("smart-basket__input-wrapper_error")) : (r.text("Оплатить"), s.val("Оплатить"), m.attr({disabled: !1}), d.removeClass("smart-basket__input-wrapper_error"))
